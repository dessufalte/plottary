    ...
    <div className="p-8">
      ...
      <div className="mb-6 flex items-center gap-3">
        <Link
          ...
          className="text-black inline-flex h-9 w-9 items-center justify-center rounded-full hover:bg-gray-100"
          title="Kembali"
        >
      ...
      <form className="space-y-5" onSubmit={onSubmit} noValidate>
        ...
        <div>
          ...
          <input
            ...
            className={`placeholder-gray-300 w-full rounded-xl border px-4 py-2.5 text-sm outline-none ring-emerald-200 focus:bg-white focus:ring ${
        ...
        <div>
          ...
          >
            ...
            <option className="text-black">Siap Santap</option>
            <option className="text-black">Roti & Kue</option>
            <option className="text-black">Minuman</option>
